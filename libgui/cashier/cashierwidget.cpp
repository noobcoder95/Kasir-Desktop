    ...
    mAddItemDialog(new AddItemUnavailableDialog(bus, this))
{
    ...
    ui->labelTitle->setText(Preference::getString(SETTING::MARKET_NAME, "CV. Usaha Sendiri"));
    ui->labelSubtitle->setText(GuiUtil::toHtml(Preference::getString(SETTING::MARKET_SUBNAME, "Jln. Karunrung\nMakassar")));
...
void CashierWidget::printBill(const QVariantMap &data)
{
    ...
    const QString &title = Preference::getString(SETTING::PRINTER_CASHIER_TITLE, "CV. Usaha Sendiri");
    const QString &subtitle = Preference::getString(SETTING::PRINTER_CASHIER_SUBTITLE, "Karunrung Raya 1");
