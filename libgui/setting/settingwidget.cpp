...
{
    ui->lineAppName->setText(Preference::getString(SETTING::MARKET_NAME, "CV. Usaha Sendiri"));
    ui->plainSubName->setPlainText(Preference::getString(SETTING::MARKET_SUBNAME, "Jl. Karunrung\nMakassar"));
...
void SettingWidget::setupPrinter()
{
    ...
    ui->linePrintCashierTitle->setText(Preference::getString(SETTING::PRINTER_CASHIER_TITLE, "CV. Usaha Sendiri"));
    ui->plainPrintCashierSubtitle->setPlainText(Preference::getString(SETTING::PRINTER_CASHIER_SUBTITLE, "Karunrung Raya 1"));
...
void SettingWidget::printTestClicked()
{
    ...
    e.cpi10()->leftText("KASIR TEST PAGE", true)->newLine()->line();
