...
int main(int argc, char *argv[])
{
...
#endif
    a.setApplicationName("kasir");
    a.setOrganizationName("nama_organisasi");
    a.setApplicationVersion("21.10.14");
    ...
    QTranslator tr[3];
    if(lang.compare("en")) {
        QStringList trans{":/translation/kasir_", ":/translation/libgui_", ":/translation/libserver_"};
