...
macx {
    QMAKE_LIBDIR += $$OUT_PWD/../bin/Kasir.app/Contents/Frameworks
    ...
    DESTDIR = ../bin
    copysh.commands = $$quote(cp -R $${PWD}/../script/Kasir.sh $${OUT_PWD}/../bin/)
    QMAKE_EXTRA_TARGETS += copysh
    POST_TARGETDEPS += copysh
}

RESOURCES += kasir.qrc sqlmigration.qrc translation.qrc

TRANSLATIONS = ../translation/kasir_id.ts
